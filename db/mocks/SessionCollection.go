...
func (_m *SessionCollection) VoteDown(ctx context.Context, sessionID string, songID string, username string) (user.Score, error) {
	ret := _m.Called(ctx, sessionID, songID, username)

	var r0 user.Score
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string) user.Score); ok {
		r0 = rf(ctx, sessionID, songID, username)
	} else {
		r0 = ret.Get(0).(user.Score)
	}
...
func (_m *SessionCollection) VoteUp(ctx context.Context, sessionID string, songID string, username string) (user.Score, error) {
	ret := _m.Called(ctx, sessionID, songID, username)
