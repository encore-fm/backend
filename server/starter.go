...
func (s *Model) listenAndServe(r *mux.Router) {
	...
	allowedHeaders := muxh.AllowedHeaders([]string{"X-Requested-With", "Content-Type", "Authorization"})
	allowedMethods := muxh.AllowedMethods([]string{"GET", "POST", "PUT", "HEAD", "OPTIONS"})
